		...
		<div class="content_car">
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content_zr">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" name="WIDout_trade_no" value="123asdqwe" />
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
					...
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" value="100.0" />
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<input class="new-btn-login" type="submit" value="付款"
...
<script type="text/javascript">
 //  "returnzfb.jsp?orderid="+orderid+"&sumprice="+sumprice
	$(document).ready(function(){ 
		...
		x--;
		$("#time").html(x);
		window.setTimeout("form1.submit()",5000);//毫秒
